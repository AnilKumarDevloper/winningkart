...
class CartController extends Controller
{
    ...
    public function addToCart(Request $request)
    {
        ...
        return array(
            'status' => 1,
            'cart_count' => count($carts),
            'modal_view' => view('frontend.megamart.partials.addedToCart', compact('product', 'cart'))->render(),
            // 'nav_cart_view' => view('frontend.'.get_setting('homepage_select').'.partials.cart')->render(),
    ...
    public function removeFromCart(Request $request)
    {
        ...
        return array(
            'cart_count' => count($carts),
            'cart_view' => view('frontend.megamart.partials.cart_details', compact('carts'))->render(),
            'nav_cart_view' => view('frontend.megamart.partials.drawer_cart')->render(),
        );
