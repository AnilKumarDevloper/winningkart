...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        // });
      $featured_categories = Category::with(['childrenCategories'])->where('featured', 1)->get();
        
        // return $featured_categories;
        
        // return view('frontend.' . get_setting('homepage_select') . '.index', compact('featured_categories', 'lang'));
        return view('frontend.megamart.index', compact('featured_categories', 'lang'));
    ...
    public function login()
    {
        ...
        return view('auth.free.user_login');
    }
