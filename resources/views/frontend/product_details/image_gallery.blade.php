...
<div class="sticky-top z-3 row gutters-10">
    ...
    <div class="col-2 mt-3 d-none d-lg-block">
        <div class="aiz-carousel half-outside-arrow product-gallery-thumb" data-items='5' data-nav-for='.product-gallery'
            data-focus-select='true' data-arrows='true' data-vertical='true' data-auto-height='true' style="display: flex; flex-direction: column; ">
    ...
    <!-- Thumbnail Images -->
    <!-- <div class="col-3 mt-3 d-none d-lg-block">
