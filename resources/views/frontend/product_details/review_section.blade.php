             ...
             <div class="tab-container">
                    ...
                    <div class="detailsContainer maxHeights">
                        <div class="tab-contents" id="description"> 
                            <div class="c-cons">
                                <div class="description-s" >
                                    <img src=" " class="w-100" style="background-size: cover;"> 
                        ...
                        <div class="tab-contents" id="ingredients">
                            <div class="description-s">
                                <p class="mb-1"><b>Key Ingredients:</b></p>
                                <ul>
                                    <li>
                                        <b>Squalane:</b>
                                        It is a non-comedogenic, 100% plant-derived emollient that helps in treating dry and chapped lips, leaving them feeling soft and supple.
                                    </li>
                                      <li>
                                        <b>Hyaluronic Acid:</b>
                                        It is an excellent humectant and moisturiser that has the ability to retain significant amounts of moisture in the skin, thereby creating a plumping effect..
                                    </li>
                                      <li>
                                        <b>Jojoba Oil:</b>
                                        It is a non-comedogenic oil derived from seed of the simmondsia chinensis (jojoba) plant, 
                                        and is rich in vitamin E. It keeps lips moisturised and nourished, thus preventing hyperpigmentation by keeping them healthy. 
                                        Lips tend to dry up more rapidly because they lack the protective film that the rest of the skin has, due to the lack of sweat 
                                        from glands and oil generated by follicles. Jojoba oil is the ideal lip care product because 
                                        it hydrates them, shields them from sunburn, and makes them appear plumper and fuller.
                                    </li>
                                      <li>
                                        <b>Niacinamide:</b>
                                        It is a non-comedogenic, 100% plant-derived emollient that helps in treating dry and chapped lips, leaving them feeling soft and supple.
                        ...
                        <div class="tab-contents" id="howToUse"> 
                            <div class="description-s">
                                <img src="https://adn-static1.nykaa.com/media/wysiwyg/EARAA00000301Artboard%201.jpg" class="w-100" style="background-size: cover; object-fit:contain">
                                <img src="https://adn-static1.nykaa.com/media/wysiwyg/EARAA00000301Artboard%203.jpg" class="w-100" style="background-size: cover; object-fit:contain">
                                <img src="https://adn-static1.nykaa.com/media/wysiwyg/EARAA00000301Artboard%202.jpg" class="w-100" style="background-size: cover; object-fit:contain">
                                <img src="https://adn-static1.nykaa.com/media/wysiwyg/EARAA00000301Artboard%205.jpg" class="w-100" style="background-size: cover; object-fit:contain">
                                <!-- <ul class="mt-2">
                    ...
                    <hr class="m-0">
                      <div class="p-2 d-flex justify-content-center">
                        <span class="readMore"><span id="readMore">Read More</span> <i class="ri-arrow-down-s-line" id="arrowclass"></i></span> 
                    </div>
             </div>   
        </div>
    </div>
