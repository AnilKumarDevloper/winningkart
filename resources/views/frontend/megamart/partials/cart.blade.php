...
<a href="javascript:void(0)" class="d-flex align-items-center text-dark px-3 h-100" data-toggle="dropdown" data-display="static" title="{{translate('Cart')}}">
    ...
    <span class="nav-box-text d-none d-xl-block text-black fs-12">
        <i class="fa fa-shopping-cart fs-16" aria-hidden="true"><span class="position-absolute  start-50 translate-middle badge rounded-pill bg-danger text-white" style="top: 10px !important; height:25px; width:25px;">{{count($carts) > 0 ? count($carts) : 0 }}</span></i>
...
<!-- Cart Items -->
<div class="right_sidebars dropdown-menu dropdown-menu-right dropdown-menu-lg p-0 stop-propagation rounded-0">
