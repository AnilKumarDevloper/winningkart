            ...
            <div class="col-lg-6 col">
                <ul class="list-inline d-flex justify-content-between justify-content-lg-start mb-0">
                    ...
                    <li class="list-inline-item dropdown mr-4">
                        <a href="javascript:void(0)" class="text-white fs-12 py-2" style="display: flex;align-items: center;">
            ...
            <div class="col-6 text-right d-none d-lg-block">
                <ul class="list-inline mb-0 h-100 d-flex justify-content-end align-items-center">
                    <li class="list-inline-item mr-0 pl-0 py-2">
                        <a href="javascript:void(0)" class="text-white fs-12 pr-3 d-inline-block border-width-2 border-right">
                            <i class="fa fa-gift" aria-hidden="true"></i>&nbsp;
                            {{ translate('Gift Card') }}
                        </a>
                    </li>
                    <!--<li class="list-inline-item mr-0 pl-0 py-2">-->
                    <!--    <a href="javascript:void(0)" class="text-white fs-12 pl-3 d-inline-block"><i class="fa fa-question-circle-o" aria-hidden="true"></i>&nbsp; {{ translate('Help') }}</a>-->
                    <!--</li>-->
    ...
    <div class="position-relative logo-bar-area border-bottom border-md-nonea z-1025">
        <div class="container">
            <div class="d-flex align-items-center justify-content-center">
                ...
                <!-- Search field -->
                <div class="flex-grow-1 front-header-search d-flex align-items-center bg-white mx-xl-5 d-none">
                ...
                <div class="d-none d-xl-block mr-0">
                    ...
                    @else
                    <!--Login & Registration -->
                    <span class="d-flex align-items-center nav-user-info" id="user-info-toggle">
                        <!-- Image -->
                        <span class="size-20px rounded-circle overflow-hidden border d-flex align-items-center justify-content-center nav-user-img">
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#user-info-toggle').on('click', function(e) {
            e.stopPropagation();
            $('#user-dropdown').toggle(); // Toggle the dropdown visibility
        });

        // Close the dropdown if clicked outside
        $(document).on('click', function() {
            $('#user-dropdown').hide(); // Hide the dropdown
        });
