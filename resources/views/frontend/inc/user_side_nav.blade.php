<div class="aiz-user-sidenav-wrap position-relative z-1 rounded-0">
    <div class="aiz-user-sidenav overflow-auto c-scrollbar-light px-4 pb-4">
        ...
        <div class="sidemnenu">
                ...
                @endphp
                 ...
                 <li class="aiz-side-nav-item">
                    <a href="{{ route('purchase_history.index') }}"
                        ...
                        <span class="aiz-side-nav-text ml-3">{{ translate('My Order') }}</span>
                  ...
                  <li class="aiz-side-nav-item">
                    <a href="{{ route('wishlists.index') }}"
                        ...
                        <span class="aiz-side-nav-text ml-3">{{ translate('My Wishlist') }}</span>
                    </a>
                </li>
            ...
            <!-- logout -->
            <a href="{{ route('logout') }}" class="btn btn-primary btn-block fs-14 fw-700 mb-5 mb-md-0" style="border-radius: 25px;">{{ translate('Log Out') }}</a>
        </div>
