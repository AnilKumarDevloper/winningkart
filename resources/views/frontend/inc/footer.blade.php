    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xl-6 col-lg-7">
                ...
                <h5 class="fs-20 fw-500 text-soft-light mt-1 mb-3">{{ translate('15% OFF your order when you sign-up to our emails') }}</h5>
                <div class="mb-3">
                    ...
                    <ul class="list-inline social colored mb-4">
                        @if (!empty(get_setting('facebook_link')))
                            <li class="list-inline-item ml-2 mr-2">
                                <a href="{{ get_setting('facebook_link') }}" aria-label="facebook" target="_blank"
                                    class="facebook"><i class="lab la-facebook-f"></i></a>
                            </li>
                        @endif
                        @if (!empty(get_setting('twitter_link')))
                            <li class="list-inline-item ml-2 mr-2">
                                <a href="{{ get_setting('twitter_link') }}" aria-label="twitter" target="_blank"
                                    class="twitter"><i class="lab la-twitter"></i></a>
                            </li>
                        @endif
                        @if (!empty(get_setting('instagram_link')))
                            <li class="list-inline-item ml-2 mr-2">
                                <a href="{{ get_setting('instagram_link') }}" aria-label="instagram" target="_blank"
                                    class="instagram"><i class="lab la-instagram"></i></a>
                            </li>
                        @endif
                        @if (!empty(get_setting('youtube_link')))
                            <li class="list-inline-item ml-2 mr-2">
                                <a href="{{ get_setting('youtube_link') }}" aria-label="youtube" target="_blank"
                                    class="youtube"><i class="lab la-youtube"></i></a>
                            </li>
                        @endif
                        @if (!empty(get_setting('linkedin_link')))
                            <li class="list-inline-item ml-2 mr-2">
                                <a href="{{ get_setting('linkedin_link') }}" aria-label="linkedin" target="_blank"
...
@endphp
<section class="py-lg-3 text-light footer-widget" style="background-color: #F3F3F3 !important;">
    ...
    <div class="d-lg-none bg-transparent">
        ...
        <div class="aiz-accordion-wrap bg-black">
            <div class="aiz-accordion-heading container bg-black">
                <button class="aiz-accordion fs-14 text-white bg-transparent"><span class="mob_sell">{{ translate('Seller Zone') }}</span><span class="mob_sell_bec">Become A Seller</span></button>
            </div>
            <div class="aiz-accordion-panel bg-transparent" style="background-color: #212129 !important;">
                <div class="container">
                    <ul class="list-unstyled mt-3">
        ...
        <div class="row no-gutters border-left border-soft-light mt-lg-0 mt-md-0 mt-4">
            ...
            <div class="col-lg-3 col-6 policy-file">
                <a class="text-reset h-100  border-right border-bottom border-soft-light text-center p-2 p-md-4 d-block hov-ls-1" href="{{ route('terms') }}">
                    ...
                    <h4 class="text-dark fs-14 fw-700 mt-3 text-capitalize">{{ translate('Terms & Conditions') }}</h4>
                </a>
            </div>
            
            <!-- Return Policy -->
            <div class="col-lg-3 col-6 policy-file">
                <a class="text-reset h-100  border-right border-bottom border-soft-light text-center p-2 p-md-4 d-block hov-ls-1 fbx575" href="{{ route('returnpolicy') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32.001" height="23.971" viewBox="0 0 32.001 23.971">
                        <path id="Union_7" data-name="Union 7" d="M-14490,18922.967a6.972,6.972,0,0,0,4.949-2.051,6.944,6.944,0,0,0,2.052-4.943,7.008,7.008,0,0,0-7-7v0h-22.1l7.295,7.295-.707.707-7.779-7.779-.708-.707.708-.7,7.774-7.779.712.707-7.261,7.258H-14490v0a8.01,8.01,0,0,1,8,8,8.008,8.008,0,0,1-8,8Z" transform="translate(14514.001 -18900)" fill="#919199"/>
                    </svg>
                    <h4 class="text-dark fs-14 fw-700 mt-3 text-capitalize">{{ translate('Return Policy') }}</h4>
                </a>
            </div>
            ...
            <div class="col-lg-3 col-6 policy-file">
                <a class="text-reset h-100  border-right border-bottom border-soft-light text-center p-2 p-md-4 d-block hov-ls-1" href="{{ route('supportpolicy') }}">
                    ...
                    <h4 class="text-dark fs-14 fw-700 mt-3 text-capitalize">{{ translate('Support Policy') }}</h4>
                </a>
            </div>
            ...
            <div class="col-lg-3 col-6 policy-file">
                <a class="text-reset h-100 border-right border-bottom border-soft-light text-center p-2 p-md-4 d-block hov-ls-1" href="{{ route('privacypolicy') }}">
                    ...
                    <h4 class="text-dark fs-14 fw-700 mt-3 text-capitalize">{{ translate('Privacy Policy') }}</h4>
                </a>
            </div>
        </div>
    </div>
...
<!-- FOOTER -->
<footer class="pt-3 pb-7 pb-xl-3 bg-black text-soft-light" style="background-color: #F3F3F3 !important;">
    <div class="container">
