                                ...
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item list-groupitem2"> 
                                        <div class="form-check d-flex justify-content-between align-items-center itemFilter"> 
                                            ...
                                            <span> <input class="form-check-input filterCheckbox" type="checkbox" value="" id="filter2"> </span>
                                        </div> 
                                    </li>
                                    <li class="list-group-item list-groupitem2"> 
                                        <div class="form-check d-flex justify-content-between align-items-center itemFilter"> 
                       ...
                       <div class="mt-3"> 
                            <div class="bg-white leftfilterItems">
                                <div class="fs-16 bg-white border filterPadding filterBorders">
                                    <a href="#category1" class="filter-section text-dark d-flex align-items-center justify-content-between" data-toggle="collapse">
                                        <span> Price</span> 
                                        <span ><i class="ri-arrow-down-s-line text-mute text-muted" style="font-size:27px; color:#666;"></i></span>
                                        <!-- <span style="padding:5px 10px'"><i class="ri-close-circle-line"></i></span> -->
                                    </a>
                                </div> 
                                    ...
                                    <ul class="listStyles p-0">
                                        <li class="filterPadding">
                                             <div class="form-check p-0 d-flex justify-content-between"> 
                                                ...
                                                <span><input class="form-check-input checkboxFilter" type="checkbox" value="" id="flexCheckDefault"></span>
                                            </div> 
                                        </li>
                                        <li class="filterPadding">
                                             <div class="form-check p-0 d-flex justify-content-between"> 
                            ...
                            <div class="bg-white leftfilterItems">
                                <div class="fs-16 bg-white border filterPadding filterBorders">
                                    <a href="#category2" class="filter-section text-dark d-flex align-items-center justify-content-between" data-toggle="collapse">
                                        <span> Category</span>
                                        <span id="openCollaps"> <i class="ri-arrow-down-s-line text-mute text-muted" style="font-size:27px; color:#666;"></i></span>
                                        <span style="padding:5px 10px'" id="closeCollapse"> <i class="ri-close-circle-line"></i></span>
                                    </a>
                                </div> 
